...
If you discover a security vulnerability in LobsterGate, please report it responsibly:
...
LobsterGate handles sensitive API keys with the following policies:
...
LobsterGate does **not** protect against:
